    ...
    <>
      ...
      {content.boundary ? (
        <section className="px-4 pb-16 sm:px-6 lg:px-8">
          <div className="container-page rounded-md border border-amber-200 bg-amber-50 p-5 text-sm leading-6 text-amber-950">
            <strong>Wichtige fachliche Grenze:</strong> {content.boundary}
          </div>
        </section>
      ) : null}
...
function LeadForm({ content, compact = false }: { content: PageContent; compact?: boolean }) {
  return (
    <section className={`section-pad ${compact ? "bg-white" : "bg-paper"}`} id="anfrage">
      <div className="container-page grid gap-10 lg:grid-cols-[0.8fr_1.2fr]">
        <div>
