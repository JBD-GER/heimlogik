...
export function Hero({
  ...
  const titleClass =
    titleSize === "compact"
      ? "max-w-3xl text-3xl font-bold tracking-normal sm:text-4xl lg:text-5xl"
      : "max-w-3xl text-4xl font-bold tracking-normal sm:text-5xl lg:text-6xl";
      ...
      <div className="container-page relative grid gap-10 px-4 py-16 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:px-8 lg:py-24">
        <div className="flex flex-col justify-center">
          ...
          <p className="mt-5 text-sm text-slate-300">
            Servicegebiet: {serviceAreaLabel ?? siteConfig.serviceRadius} · Telefon: {siteConfig.phone}
          </p>
        </div>
        {image ? (
