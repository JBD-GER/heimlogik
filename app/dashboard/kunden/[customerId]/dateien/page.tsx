...
export default async function CustomerFilesPage({ params }: PageProps) {
  ...
  if (files.length === 0) return <EmptyState title="Noch keine Dateien" description="Dateien liegen privat in Supabase Storage und werden hier über die File-Tabelle angezeigt." />;
