...
export const metadata: Metadata = {
  ...
  title: {
    default: "Smart Home Installateur Nienburg | Heimlogik",
    template: "%s | Heimlogik",
  },
  description:
    "Heimlogik plant, integriert und programmiert Smart-Home-Systeme für Leese, Nienburg, Wunstorf, Hannover West und die Region Hannover.",
  icons: {
