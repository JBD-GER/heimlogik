...
export const metadata: Metadata = {
  ...
  description:
    "Kontaktieren Sie Heimlogik für Smart-Home-Planung, Installation und Systemintegration in Wunstorf, Isernhagen und Hannover.",
...
export default function KontaktPage() {
  return (
    <>
      ...
      <section className="section-pad scroll-mt-24 md:scroll-mt-28" id="anfrage">
