    ...
    <>
      ...
      <section className="section-pad">
        <div className="container-page grid gap-6 lg:grid-cols-3">
          {[
            ["Smart-Home-Planung", "Wir übersetzen Wünsche, Grundrisse und technische Möglichkeiten in ein klares Smart-Home-Konzept."],
            ["Systemintegration", "Wir verbinden Licht, Beschattung, Heizung, Sicherheit, Energie und Bedienung zu einem funktionierenden Gesamtsystem."],
            ["Projektkoordination", "Wir stimmen Systemlogik, Nutzerwunsch und Fachpartner so ab, dass die Umsetzung nachvollziehbar bleibt."],
          ].map(([title, text]) => (
