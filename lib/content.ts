...
export const navItems = [
  ...
  { href: "/hifi-audio-tv-integration", label: "HiFi, Audio & TV" },
...
export const serviceCards = [
  ...
  {
    icon: Speaker,
    title: "HiFi, Audio & TV Integration",
    text: "Multiroom-Audio, Beschallung, TV, Mediensteuerung und Szenen sinnvoll ins Smart Home einbinden.",
    href: "/hifi-audio-tv-integration",
  },
  {
    icon: ShieldCheck,
...
export const servicePages: Record<string, PageContent> = {
  ...
  "/hifi-audio-tv-integration": {
    path: "/hifi-audio-tv-integration",
    metaTitle: "HiFi, Audio & TV Integration | Heimlogik",
    metaDescription:
      "HiFi, Audio, TV und Beschallungssysteme ins Smart Home integrieren: Multiroom-Audio, Mediensteuerung, TV-Szenen und Bedienung mit Heimlogik.",
    h1: "HiFi, Audio & TV Integration für Ihr Smart Home",
    kicker: "Multiroom-Audio, Beschallung, TV und Mediensteuerung",
    heroText:
      "Heimlogik plant und integriert Audio-, HiFi- und TV-Lösungen so, dass Musik, Beschallung, Fernsehen, Licht und Szenen im Alltag sauber zusammenspielen.",
    heroBullets: [
      "Multiroom-Audio und Beschallungssysteme",
      "TV, Heimkino und Mediensteuerung",
      "Szenen für Musik, Film, Gäste und Alltag",
      "Einbindung in App, Taster und Smart-Home-Visualisierung",
    ],
    primaryCta: "Audio- und TV-Projekt besprechen",
    secondaryCta: "Leistungen ansehen",
    secondaryHref: "/leistungen",
    imageSrc: "/images/heimlogik-smart-home-hero.png",
    imageAlt: "HiFi Audio und TV Integration im Smart Home",
    icon: Speaker,
    serviceName: "HiFi, Audio & TV Integration",
    serviceType: "Smart Home Audio und TV Integration",
    sections: [
      {
        title: "Wenn Medien Technik nicht komplizierter machen sollen",
        text: "Gute Audio- und TV-Technik soll im Alltag Freude machen, nicht noch mehr Fernbedienungen, Apps und einzelne Insellösungen erzeugen. Heimlogik denkt Bedienung, Räume und Szenen von Anfang an mit.",
        items: ["weniger Fernbedienungschaos", "klare Räume und Zonen", "verständliche App-Struktur", "passende Bedienung für Familie und Gäste"],
      },
      {
        title: "Audio, TV und Smart Home sinnvoll verbinden",
        text: "Wir planen, konfigurieren und integrieren passende Medienlösungen mit Ihrem Smart Home. So können Musik, TV, Licht, Beschattung und Anwesenheitsszenen gemeinsam gesteuert werden.",
        items: ["Musik und Licht als Szene", "TV-Abend mit passender Beschattung", "Gäste- oder Party-Modus", "zentrale Bedienung über App oder Taster"],
      },
      {
        title: "Typische Leistungen",
        items: [
          "Multiroom-Audio",
          "Beschallungssysteme",
          "HiFi-Integration",
          "TV- und Mediensteuerung",
          "Heimkino-Grundkonzept",
          "Streaming- und Quellenlogik",
          "Netzwerk- und WLAN-Prüfung",
          "Einweisung in Bedienung und Szenen",
        ],
      },
      {
        title: "Wichtig für stabile Medienlösungen",
        text: "Audio- und TV-Systeme hängen stark von Netzwerk, Stromversorgung, Raumstruktur, Bedienwunsch und Schnittstellen ab. Vor einer Empfehlung prüfen wir deshalb, welche Lösung technisch und im Alltag wirklich passt.",
        items: ["Netzwerk und WLAN", "Räume und Hörzonen", "Kabelwege und Montagepunkte", "Schnittstellen zu Smart-Home-Systemen"],
      },
      {
        title: "Teil der gesamten Gebäudelösung",
        text: "Audio und TV können eigenständig geplant oder als Teil eines größeren Smart-Home-Projekts eingebunden werden. Besonders sinnvoll ist die Verbindung mit Licht, Beschattung, Zutritt und Anwesenheitsszenen.",
        links: [
          { label: "Licht & Rollläden", href: "/licht-rollladen-beschattung" },
          { label: "KNX & Home Assistant", href: "/knx-home-assistant-systemintegration" },
    ...
    boundary:
      "Heimlogik plant, richtet ein und integriert Audio-, TV- und Medienlösungen. Feste Elektroarbeiten, Wandmontagen mit elektrischen Anschlüssen, Leitungsverlegung und bauliche Arbeiten erfolgen bei Bedarf über qualifizierte Fachpartner.",
    faqs: [
      { question: "Kann Heimlogik Multiroom-Audio einrichten?", answer: "Ja. Wir prüfen Räume, Netzwerk, Bedienwunsch und passende Systeme, richten Zonen ein und erklären die Bedienung verständlich." },
      { question: "Kann TV oder Heimkino mit Licht und Beschattung verbunden werden?", answer: "Ja. Je nach System können Szenen etwa Licht, Beschattung, TV und Audio gemeinsam steuern." },
      { question: "Plant Heimlogik auch Beschallungssysteme?", answer: "Ja, für Wohnräume, Terrassen, Ferienwohnungen oder kleinere Gewerbeobjekte können Beschallungslösungen geplant und in die Bedienung eingebunden werden." },
      { question: "Wer übernimmt Kabel, Wandmontage und feste Anschlüsse?", answer: "Feste Elektroarbeiten, Leitungsverlegung, Montagepunkte und bauliche Arbeiten stimmen wir bei Bedarf mit qualifizierten Fachpartnern ab." },
      ...globalServiceFaqs,
    ],
  },
