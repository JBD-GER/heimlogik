...
export const trustBadges = [
  ...
  { icon: Home, label: "Regionaler Ansprechpartner aus 31633 Leese" },
...
export const heroVariants = [
  {
    headline: "Smart Home, das einfach funktioniert.",
    subline:
      "Heimlogik plant, integriert und programmiert intelligente Gebäudetechnik für Häuser, Neubauten und hochwertige Immobilien in Nienburg und der Region Hannover.",
  },
  {
  ...
  {
    headline: "Ihr Smart-Home-Systemintegrator für Nienburg & Hannover West.",
    subline:
  ...
  },
  {
    ...
    subline:
      "Heimlogik ist Ihr regionaler Ansprechpartner für Smart-Home-Planung, Installation und Programmierung in Nienburg, Leese, Wunstorf und Hannover West.",
  },
  {
...
export const servicePages: Record<string, PageContent> = {
  "/knx-loxone-systemintegration": {
    ...
    metaDescription:
      "KNX- und Loxone-kompatible Smart-Home-Planung für Neubau, Sanierung und Premium-Immobilien in Nienburg, Wunstorf und Hannover West.",
  ...
  "/smarte-heizkoerperthermostate": {
    ...
    metaDescription:
      "Smarte Heizkörperthermostate nachrüsten lassen: Montage, App-Einrichtung, Zeitpläne und Einweisung in Nienburg, Leese, Wunstorf und Hannover West.",
    h1: "Smarte Heizkörperthermostate installieren lassen",
    heroHeadline: "Smarte Heizkörperthermostate installieren lassen",
    kicker: "Heizkörper per App steuern in Nienburg und Hannover West",
    heroText:
    ...
    imageAlt: "Smarte Heizkörperthermostate installieren lassen in Nienburg",
    icon: Thermometer,
  ...
  "/ferienwohnung-smart-home": {
    ...
    metaDescription:
      "WLAN, Smart Lock, smarte Heizung, Sensoren und QR-Gästeanleitung für Ferienwohnungen in Nienburg, Wunstorf und Hannover West.",
...
export const localPages: Record<string, PageContent> = {
  ...
  "/smart-home-neustadt-am-ruebenberge": localPage("Neustadt am Rübenberge", "Smart Home Neustadt am Rübenberge", "Smart Home Neustadt am Rübenberge | Heimlogik", "Smart Home in Neustadt am Rübenberge: Planung, Nachrüstung, smarte Heizkörperthermostate, Sicherheit, Licht und Energie mit Heimlogik.", "Smart Home in Neustadt am Rübenberge - klar geplant, verständlich bedienbar", "Zwischen Landkreis Nienburg und Region Hannover betreut Heimlogik Projekte in Neustadt am Rübenberge mit Fokus auf Bedienbarkeit, Systemlogik und saubere Umsetzung."),
...
function localPage(
  ...
  return {
    ...
    boundary: siteConfig.electricianPartnerText,
    faqs: [
      { question: `Bietet Heimlogik Smart Home in ${city} an?`, answer: `Ja. Heimlogik betreut Smart-Home-Projekte in ${city} sowie im Landkreis Nienburg und der westlichen Region Hannover.` },
...
export const footerServices = [
  ["Smart Home installieren lassen", "/leistungen"],
  ["Smart Home Planung", "/leistungen"],
